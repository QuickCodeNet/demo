...
- **Module APIs:**
    - link: [https://demo-identity-module.quickcode.net](https://demo-identity-module.quickcode.net)
    - etc.
...
```json
{
  ...
  "Clusters": {
    "identity-module-api": {
      "Destinations": {
        "destination1": {
          "Address": "https://demo-identity-module.quickcode.net"
        }
      }
    }
  }
...
1. Open `src/QuickCode.Demo.Docker.sln` in Rider.
...
**Last generation Time**: [Generated on: 2026-07-23 20:48:25 UTC]