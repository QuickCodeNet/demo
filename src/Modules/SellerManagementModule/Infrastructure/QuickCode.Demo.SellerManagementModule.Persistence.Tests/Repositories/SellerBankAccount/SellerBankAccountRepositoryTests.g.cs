...
{
    public class SellerBankAccountRepositoryTests : IDisposable
    {
        private readonly Mock<IDbConnectionFactory> connectionFactoryMock;
        private readonly Mock<ILogger<SellerBankAccountRepository>> loggerMock;
        private readonly ITestOutputHelper _output;
        public SellerBankAccountRepositoryTests(ITestOutputHelper output)
        {
            _output = output;
            connectionFactoryMock = new Mock<IDbConnectionFactory>();
            loggerMock = new Mock<ILogger<SellerBankAccountRepository>>();
        }

        private SellerBankAccountRepository CreateRepository()
        {
            return new SellerBankAccountRepository(loggerMock.Object, connectionFactoryMock.Object);
        }
