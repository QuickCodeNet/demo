...
{
    public class SellerTierRepositoryTests : IDisposable
    {
        private readonly Mock<IDbConnectionFactory> connectionFactoryMock;
        private readonly Mock<ILogger<SellerTierRepository>> loggerMock;
        private readonly ITestOutputHelper _output;
        public SellerTierRepositoryTests(ITestOutputHelper output)
        {
            _output = output;
            connectionFactoryMock = new Mock<IDbConnectionFactory>();
            loggerMock = new Mock<ILogger<SellerTierRepository>>();
        }

        private SellerTierRepository CreateRepository()
        {
            return new SellerTierRepository(loggerMock.Object, connectionFactoryMock.Object);
        }
