...
{
    public class SellerPerformanceReviewRepositoryTests : IDisposable
    {
        private readonly Mock<IDbConnectionFactory> connectionFactoryMock;
        private readonly Mock<ILogger<SellerPerformanceReviewRepository>> loggerMock;
        private readonly ITestOutputHelper _output;
        public SellerPerformanceReviewRepositoryTests(ITestOutputHelper output)
        {
            _output = output;
            connectionFactoryMock = new Mock<IDbConnectionFactory>();
            loggerMock = new Mock<ILogger<SellerPerformanceReviewRepository>>();
        }

        private SellerPerformanceReviewRepository CreateRepository()
        {
            return new SellerPerformanceReviewRepository(loggerMock.Object, connectionFactoryMock.Object);
        }
