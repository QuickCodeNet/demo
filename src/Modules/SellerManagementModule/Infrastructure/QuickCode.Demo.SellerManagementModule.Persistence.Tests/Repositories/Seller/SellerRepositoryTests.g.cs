...
namespace QuickCode.Demo.SellerManagementModule.Persistence.Tests.Repositories
{
    public class SellerRepositoryTests : IDisposable
    {
        ...
        private readonly Mock<ILogger<SellerRepository>> loggerMock;
        private readonly ITestOutputHelper _output;
        public SellerRepositoryTests(ITestOutputHelper output)
        {
            _output = output;
            connectionFactoryMock = new Mock<IDbConnectionFactory>();
            loggerMock = new Mock<ILogger<SellerRepository>>();
        }

        private SellerRepository CreateRepository()
        {
            return new SellerRepository(loggerMock.Object, connectionFactoryMock.Object);
        }
