...
{
    public class SellerBankAccountTests : IDisposable
    {
        ...
        public async Task ListAsync_Should_Return_Success_When_Valid_Request()
        {
            ...
            var fakeResponse = new RepoResponse<List<SellerBankAccountDto>>(fakeList, "Success");
