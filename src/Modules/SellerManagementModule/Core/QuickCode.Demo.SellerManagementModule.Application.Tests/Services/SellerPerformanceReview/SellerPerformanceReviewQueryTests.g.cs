...
{
    public class SellerPerformanceReviewTests : IDisposable
    {
        ...
        public SellerPerformanceReviewTests()
        {
        ...
        public async Task ListAsync_Should_Return_Success_When_Valid_Request()
        {
            ...
            var fakeResponse = new RepoResponse<List<SellerPerformanceReviewDto>>(fakeList, "Success");
