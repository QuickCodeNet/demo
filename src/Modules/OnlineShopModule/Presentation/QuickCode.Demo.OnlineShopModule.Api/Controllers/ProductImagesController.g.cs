...
namespace QuickCode.Demo.OnlineShopModule.Api.Controllers
{
    public partial class ProductImagesController : QuickCodeBaseApiController
    {
        ...
        [HttpGet("get-valid-product-images/{productImagesProductId:int}")]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(List<GetValidProductImagesResponseDto>))]
        [ProducesResponseType(StatusCodes.Status404NotFound, Type = typeof(string))]
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))]
        public async Task<IActionResult> GetValidProductImagesAsync(int productImagesProductId)
        {
            var response = await service.GetValidProductImagesAsync(productImagesProductId);
