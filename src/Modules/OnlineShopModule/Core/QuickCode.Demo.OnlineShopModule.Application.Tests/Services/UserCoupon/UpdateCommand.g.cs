...
{
    public class UpdateUserCouponCommandTests : IDisposable
    {
        ...
        public UpdateUserCouponCommandTests()
        {
        ...
        public async Task UpdateAsync_Should_Return_Success_When_Item_Exists()
        {
            ...
            _repositoryMock.Setup(r => r.UpdateAsync(It.IsAny<UserCouponDto>())).ReturnsAsync(fakeUpdateResponse);
            // Act
            var result = await _service.UpdateAsync(fakeDto.UserId, fakeDto.CouponId, fakeDto);
            // Assert
            Assert.Equal(ResultCodeSuccess, result.Code);
            Assert.True(result.Value);
            _repositoryMock.Verify(r => r.GetByPkAsync(fakeDto.UserId, fakeDto.CouponId), Times.Once);
            _repositoryMock.Verify(r => r.UpdateAsync(It.IsAny<UserCouponDto>()), Times.Once);
        }
        ...
        public async Task UpdateAsync_Should_Return_NotFound_When_Item_Does_Not_Exist()
        {
            ...
            _repositoryMock.Verify(r => r.GetByPkAsync(fakeDto.UserId, fakeDto.CouponId), Times.Once);
            _repositoryMock.Verify(r => r.UpdateAsync(It.IsAny<UserCouponDto>()), Times.Never);
        }
