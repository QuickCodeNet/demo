...
namespace QuickCode.Demo.ProductCatalogModule.Persistence.Tests.Repositories
{
    public class BrandRepositoryTests : IDisposable
    {
        ...
        private readonly Mock<ILogger<BrandRepository>> loggerMock;
        private readonly ITestOutputHelper _output;
        public BrandRepositoryTests(ITestOutputHelper output)
        {
            _output = output;
            connectionFactoryMock = new Mock<IDbConnectionFactory>();
            loggerMock = new Mock<ILogger<BrandRepository>>();
        }

        private BrandRepository CreateRepository()
        {
            return new BrandRepository(loggerMock.Object, connectionFactoryMock.Object);
        }
