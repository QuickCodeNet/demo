...
namespace QuickCode.Demo.ProductCatalogModule.Persistence.Tests.Repositories
{
    public class AttributeRepositoryTests : IDisposable
    {
        ...
        private readonly Mock<ILogger<AttributeRepository>> loggerMock;
        private readonly ITestOutputHelper _output;
        public AttributeRepositoryTests(ITestOutputHelper output)
        {
            _output = output;
            connectionFactoryMock = new Mock<IDbConnectionFactory>();
            loggerMock = new Mock<ILogger<AttributeRepository>>();
        }

        private AttributeRepository CreateRepository()
        {
            return new AttributeRepository(loggerMock.Object, connectionFactoryMock.Object);
        }
