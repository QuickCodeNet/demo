...
namespace QuickCode.Demo.ProductCatalogModule.Persistence.Tests.Repositories
{
    public class ProductVariantRepositoryTests : IDisposable
    {
        ...
        private readonly Mock<ILogger<ProductVariantRepository>> loggerMock;
        private readonly ITestOutputHelper _output;
        public ProductVariantRepositoryTests(ITestOutputHelper output)
        {
            _output = output;
            connectionFactoryMock = new Mock<IDbConnectionFactory>();
            loggerMock = new Mock<ILogger<ProductVariantRepository>>();
        }

        private ProductVariantRepository CreateRepository()
        {
            return new ProductVariantRepository(loggerMock.Object, connectionFactoryMock.Object);
        }
