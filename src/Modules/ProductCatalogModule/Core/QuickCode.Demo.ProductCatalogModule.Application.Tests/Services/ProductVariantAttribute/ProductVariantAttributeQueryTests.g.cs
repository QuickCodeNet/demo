...
{
    public class ProductVariantAttributeTests : IDisposable
    {
        ...
        public ProductVariantAttributeTests()
        {
        ...
        public async Task GetItemAsync_Should_Return_Success_When_Item_Exists()
        {
            ...
            _repositoryMock.Setup(r => r.GetByPkAsync(fakeDto.VariantId, fakeDto.AttributeValueId)).ReturnsAsync(fakeResponse);
            // Act
            var result = await _service.GetItemAsync(fakeDto.VariantId, fakeDto.AttributeValueId);
            // Assert
        ...
        public async Task ListAsync_Should_Return_Success_When_Valid_Request()
        {
            ...
            var fakeResponse = new RepoResponse<List<ProductVariantAttributeDto>>(fakeList, "Success");
