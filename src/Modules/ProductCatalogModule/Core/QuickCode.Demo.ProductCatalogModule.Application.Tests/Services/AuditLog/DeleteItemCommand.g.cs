...
using QuickCode.Demo.ProductCatalogModule.Application.Services.AuditLog;
...
namespace QuickCode.Demo.ProductCatalogModule.Application.Tests.Services.AuditLog
{
