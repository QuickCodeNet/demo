...
{
    public class SellerCommissionAssignmentTests : IDisposable
    {
        ...
        public SellerCommissionAssignmentTests()
        {
        ...
        public async Task GetItemAsync_Should_Return_Success_When_Item_Exists()
        {
            ...
            _repositoryMock.Setup(r => r.GetByPkAsync(fakeDto.SellerId)).ReturnsAsync(fakeResponse);
            // Act
            var result = await _service.GetItemAsync(fakeDto.SellerId);
            // Assert
        ...
        public async Task ListAsync_Should_Return_Success_When_Valid_Request()
        {
            ...
            var fakeResponse = new RepoResponse<List<SellerCommissionAssignmentDto>>(fakeList, "Success");
