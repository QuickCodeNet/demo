...
using QuickCode.Demo.PricingEngineModule.Application.Services.AuditLog;
...
namespace QuickCode.Demo.PricingEngineModule.Application.Tests.Services.AuditLog
{
