...
{
    public class PromotionalCampaignTests : IDisposable
    {
        ...
        public PromotionalCampaignTests()
        {
        ...
        public async Task ListAsync_Should_Return_Success_When_Valid_Request()
        {
            ...
            var fakeResponse = new RepoResponse<List<PromotionalCampaignDto>>(fakeList, "Success");
