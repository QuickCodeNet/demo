...
builder.Services.AddOpenTelemetry()
    .ConfigureResource(resource => resource
        .AddService(serviceName: "QuickCode.Demo.PricingEngineModule.Api"))
...
builder.Services.AddQuickCodeRepositories("QuickCode.Demo.PricingEngineModule.Persistence", "QuickCode.Demo.PricingEngineModule.Application");
