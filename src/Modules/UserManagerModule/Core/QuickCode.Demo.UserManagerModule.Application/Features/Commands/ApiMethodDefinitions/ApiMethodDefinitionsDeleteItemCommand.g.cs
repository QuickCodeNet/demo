...
namespace QuickCode.Demo.UserManagerModule.Application.Features
{
    public class ApiMethodDefinitionsDeleteItemCommand : IRequest<Response<bool>>
    {
        ...
        public ApiMethodDefinitionsDeleteItemCommand(string key)
        {
            this.Key = key;
        }
        ...
        public class ApiMethodDefinitionsDeleteItemHandler : IRequestHandler<ApiMethodDefinitionsDeleteItemCommand, Response<bool>>
        {
            ...
            public ApiMethodDefinitionsDeleteItemHandler(ILogger<ApiMethodDefinitionsDeleteItemHandler> logger, IApiMethodDefinitionsRepository repository)
            {
                _logger = logger;
