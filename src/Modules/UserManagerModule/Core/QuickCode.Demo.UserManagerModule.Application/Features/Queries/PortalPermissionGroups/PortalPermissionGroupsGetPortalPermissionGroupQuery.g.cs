...
namespace QuickCode.Demo.UserManagerModule.Application.Features
{
    public class PortalPermissionGroupsGetPortalPermissionGroupQuery : IRequest<Response<List<PortalPermissionGroupsGetPortalPermissionGroupResponseDto>>>
    {
        ...
        public PortalPermissionGroupsGetPortalPermissionGroupQuery(string portalPermissionGroupsPortalPermissionName, string portalPermissionGroupsPermissionGroupName, int portalPermissionGroupsPortalPermissionTypeId)
        {
        ...
        public class PortalPermissionGroupsGetPortalPermissionGroupHandler : IRequestHandler<PortalPermissionGroupsGetPortalPermissionGroupQuery, Response<List<PortalPermissionGroupsGetPortalPermissionGroupResponseDto>>>
        {
            ...
            {
                var returnValue = await _repository.PortalPermissionGroupsGetPortalPermissionGroupAsync(request.PortalPermissionGroupsPortalPermissionName, request.PortalPermissionGroupsPermissionGroupName, request.PortalPermissionGroupsPortalPermissionTypeId);
