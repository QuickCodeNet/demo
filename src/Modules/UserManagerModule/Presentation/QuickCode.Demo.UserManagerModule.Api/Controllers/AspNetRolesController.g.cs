...
namespace QuickCode.Demo.UserManagerModule.Api.Controllers
{
    public partial class AspNetRolesController : QuickCodeBaseApiController
    {
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(List<AspNetRolesGetAspNetUserRolesForAspNetRolesResponseDto>))]
        [ProducesResponseType(StatusCodes.Status404NotFound, Type = typeof(string))]
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))]
        public async Task<IActionResult> GetAspNetUserRolesForAspNetRolesAsync(string aspNetRolesId)
        {
            var response = await mediator.Send(new AspNetRolesGetAspNetUserRolesForAspNetRolesQuery(aspNetRolesId));
            if (response.Code == 404)
            {
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(AspNetRolesGetAspNetUserRolesForAspNetRolesResponseDto))]
        [ProducesResponseType(StatusCodes.Status404NotFound, Type = typeof(string))]
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))]
        ...
        {
            var response = await mediator.Send(new AspNetRolesGetAspNetUserRolesForAspNetRolesDetailsQuery(aspNetRolesId, aspNetUserRolesUserId));
            if (response.Code == 404)
            {
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(List<AspNetRolesGetAspNetRoleClaimsForAspNetRolesResponseDto>))]
        [ProducesResponseType(StatusCodes.Status404NotFound, Type = typeof(string))]
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))]
        public async Task<IActionResult> GetAspNetRoleClaimsForAspNetRolesAsync(string aspNetRolesId)
        {
            var response = await mediator.Send(new AspNetRolesGetAspNetRoleClaimsForAspNetRolesQuery(aspNetRolesId));
            if (response.Code == 404)
            {
                var notFoundMessage = $"AspNetRolesId: '{aspNetRolesId}' not found in AspNetRoles Table";
                logger.LogWarning($"List Error: '{notFoundMessage}''");
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(AspNetRolesGetAspNetRoleClaimsForAspNetRolesResponseDto))]
        [ProducesResponseType(StatusCodes.Status404NotFound, Type = typeof(string))]
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))]
        ...
        {
            var response = await mediator.Send(new AspNetRolesGetAspNetRoleClaimsForAspNetRolesDetailsQuery(aspNetRolesId, aspNetRoleClaimsId));
            if (response.Code == 404)
            {
