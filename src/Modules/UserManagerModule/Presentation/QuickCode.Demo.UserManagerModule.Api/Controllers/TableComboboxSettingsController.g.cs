...
namespace QuickCode.Demo.UserManagerModule.Api.Controllers
{
    public partial class TableComboboxSettingsController : QuickCodeBaseApiController
    {
        ...
        public TableComboboxSettingsController(IMapper mapper, IMediator mediator, IServiceProvider serviceProvider, ILogger<TableComboboxSettingsController> logger)
        {
            this.mapper = mapper;
