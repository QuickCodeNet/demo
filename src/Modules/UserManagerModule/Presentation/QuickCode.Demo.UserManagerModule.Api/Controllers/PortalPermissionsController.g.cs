...
namespace QuickCode.Demo.UserManagerModule.Api.Controllers
{
    public partial class PortalPermissionsController : QuickCodeBaseApiController
    {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound, Type = typeof(string))]
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))]
        public async Task<IActionResult> GetPortalPermissionGroupsForPortalPermissionsAsync(int portalPermissionsId)
        {
            var response = await mediator.Send(new PortalPermissionsGetPortalPermissionGroupsForPortalPermissionsQuery(portalPermissionsId));
            if (response.Code == 404)
            {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound, Type = typeof(string))]
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))]
        public async Task<IActionResult> GetPortalPermissionGroupsForPortalPermissionsDetailsAsync(int portalPermissionsId, int portalPermissionGroupsId)
        {
            var response = await mediator.Send(new PortalPermissionsGetPortalPermissionGroupsForPortalPermissionsDetailsQuery(portalPermissionsId, portalPermissionGroupsId));
            if (response.Code == 404)
            {
