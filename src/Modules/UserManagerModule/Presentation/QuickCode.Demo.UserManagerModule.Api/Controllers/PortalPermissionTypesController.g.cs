...
namespace QuickCode.Demo.UserManagerModule.Api.Controllers
{
    public partial class PortalPermissionTypesController : QuickCodeBaseApiController
    {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound, Type = typeof(string))]
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))]
        public async Task<IActionResult> GetPortalPermissionGroupsForPortalPermissionTypesDetailsAsync(int portalPermissionTypesId, int portalPermissionGroupsId)
        {
            var response = await mediator.Send(new PortalPermissionTypesGetPortalPermissionGroupsForPortalPermissionTypesDetailsQuery(portalPermissionTypesId, portalPermissionGroupsId));
            if (response.Code == 404)
            {
