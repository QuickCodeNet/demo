...
namespace QuickCode.Demo.UserManagerModule.Api.Controllers
{
    public partial class PortalPermissionGroupsController : QuickCodeBaseApiController
    {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound, Type = typeof(string))]
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))]
        public async Task<IActionResult> GetPortalPermissionGroupsAsync(int portalPermissionGroupsPermissionGroupId)
        {
            var response = await mediator.Send(new PortalPermissionGroupsGetPortalPermissionGroupsQuery(portalPermissionGroupsPermissionGroupId));
            if (response.Code == 404)
            {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound, Type = typeof(string))]
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))]
        public async Task<IActionResult> GetPortalPermissionGroupAsync(int portalPermissionGroupsPortalPermissionId, int portalPermissionGroupsPermissionGroupId, int portalPermissionGroupsPortalPermissionTypeId)
        {
            var response = await mediator.Send(new PortalPermissionGroupsGetPortalPermissionGroupQuery(portalPermissionGroupsPortalPermissionId, portalPermissionGroupsPermissionGroupId, portalPermissionGroupsPortalPermissionTypeId));
            if (response.Code == 404)
            {
