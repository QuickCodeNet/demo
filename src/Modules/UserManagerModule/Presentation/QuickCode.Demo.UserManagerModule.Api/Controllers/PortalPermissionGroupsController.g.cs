...
namespace QuickCode.Demo.UserManagerModule.Api.Controllers
{
    public partial class PortalPermissionGroupsController : QuickCodeBaseApiController
    {
        ...
        public PortalPermissionGroupsController(IMapper mapper, IMediator mediator, IServiceProvider serviceProvider, ILogger<PortalPermissionGroupsController> logger)
        {
            this.mapper = mapper;
