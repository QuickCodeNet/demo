...
namespace QuickCode.Demo.UserManagerModule.Api.Tests
{
    public class AspNetUserLoginsControllerTests
    {
        ...
        {
            // Arrange
            var fakeList = TestDataGenerator.CreateFakes<AspNetUserLoginsDto>("tr");
            _mediatorMock.Setup(m => m.Send(It.IsAny<AspNetUserLoginsListQuery>(), default)).ReturnsAsync(new Response<List<AspNetUserLoginsDto>> { Code = 0, Value = fakeList });
            // Act
        ...
        {
            // Arrange
            _mediatorMock.Setup(m => m.Send(It.IsAny<AspNetUserLoginsListQuery>(), default)).ReturnsAsync(new Response<List<AspNetUserLoginsDto>> { Code = 1, Message = "Error" });
            // Act
            var result = await _controller.ListAsync(1, 10);
            // Assert
        ...
        {
            // Arrange
            _mediatorMock.Setup(m => m.Send(It.IsAny<AspNetUserLoginsTotalItemCountQuery>(), default)).ReturnsAsync(new Response<int> { Code = 0, Value = 5 });
            // Act
        ...
        {
            // Arrange
            _mediatorMock.Setup(m => m.Send(It.IsAny<AspNetUserLoginsTotalItemCountQuery>(), default)).ReturnsAsync(new Response<int> { Code = 1, Message = "Error" });
            // Act
            var result = await _controller.CountAsync();
            // Assert
            var badRequest = Assert.IsType<BadRequestObjectResult>(result);
        ...
        public async Task GetItemAsync_Should_Return_Ok_When_Found()
        {
            ...
            _mediatorMock.Setup(m => m.Send(It.IsAny<AspNetUserLoginsGetItemQuery>(), default)).ReturnsAsync(new Response<AspNetUserLoginsDto> { Code = 0, Value = fakeDto });
            // Act
        ...
        public async Task GetItemAsync_Should_Return_NotFound_When_404()
        {
            // Arrange
            var fakeDto = TestDataGenerator.CreateFake<AspNetUserLoginsDto>("tr");
            _mediatorMock.Setup(m => m.Send(It.IsAny<AspNetUserLoginsGetItemQuery>(), default)).ReturnsAsync(new Response<AspNetUserLoginsDto> { Code = 404, Message = "Not found" });
            // Act
            var result = await _controller.GetItemAsync(fakeDto.LoginProvider, fakeDto.ProviderKey);
            // Assert
            Assert.IsType<NotFoundObjectResult>(result);
        ...
        public async Task GetItemAsync_Should_Return_BadRequest_When_Fail()
        {
            // Arrange
            var fakeDto = TestDataGenerator.CreateFake<AspNetUserLoginsDto>("tr");
            _mediatorMock.Setup(m => m.Send(It.IsAny<AspNetUserLoginsGetItemQuery>(), default)).ReturnsAsync(new Response<AspNetUserLoginsDto> { Code = 1, Message = "Error" });
            // Act
            var result = await _controller.GetItemAsync(fakeDto.LoginProvider, fakeDto.ProviderKey);
            // Assert
        ...
        public async Task InsertAsync_Should_Return_Created_When_Success()
        {
            // Arrange
            var fakeDto = TestDataGenerator.CreateFake<AspNetUserLoginsDto>("tr");
            _mediatorMock.Setup(m => m.Send(It.IsAny<AspNetUserLoginsInsertCommand>(), default)).ReturnsAsync(new Response<AspNetUserLoginsDto> { Code = 0, Value = fakeDto });
            // Act
        ...
        public async Task InsertAsync_Should_Return_BadRequest_When_Fail()
        {
            // Arrange
            var fakeDto = TestDataGenerator.CreateFake<AspNetUserLoginsDto>("tr");
            _mediatorMock.Setup(m => m.Send(It.IsAny<AspNetUserLoginsInsertCommand>(), default)).ReturnsAsync(new Response<AspNetUserLoginsDto> { Code = 1, Message = "Insert failed" });
            // Act
            var result = await _controller.InsertAsync(fakeDto);
            // Assert
            Assert.IsType<BadRequestObjectResult>(result);
        ...
        public async Task UpdateAsync_Should_Return_Ok_When_Success()
        {
            // Arrange
            var fakeDto = TestDataGenerator.CreateFake<AspNetUserLoginsDto>("tr");
            _mediatorMock.Setup(m => m.Send(It.IsAny<AspNetUserLoginsUpdateCommand>(), default)).ReturnsAsync(new Response<bool> { Code = 0, Value = true });
            // Act
        ...
        public async Task UpdateAsync_Should_Return_NotFound_When_404()
        {
            // Arrange
            var fakeDto = TestDataGenerator.CreateFake<AspNetUserLoginsDto>("tr");
            _mediatorMock.Setup(m => m.Send(It.IsAny<AspNetUserLoginsUpdateCommand>(), default)).ReturnsAsync(new Response<bool> { Code = 404, Message = "Not found" });
            // Act
            var result = await _controller.UpdateAsync(fakeDto.LoginProvider, fakeDto.ProviderKey, fakeDto);
            // Assert
            Assert.IsType<NotFoundObjectResult>(result);
        ...
        public async Task UpdateAsync_Should_Return_BadRequest_When_Fail()
        {
            // Arrange
            var fakeDto = TestDataGenerator.CreateFake<AspNetUserLoginsDto>("tr");
            _mediatorMock.Setup(m => m.Send(It.IsAny<AspNetUserLoginsUpdateCommand>(), default)).ReturnsAsync(new Response<bool> { Code = 1, Message = "Update failed" });
            // Act
            var result = await _controller.UpdateAsync(fakeDto.LoginProvider, fakeDto.ProviderKey, fakeDto);
            // Assert
            Assert.IsType<BadRequestObjectResult>(result);
        ...
        public async Task DeleteAsync_Should_Return_Ok_When_Success()
        {
            // Arrange
            var fakeDto = TestDataGenerator.CreateFake<AspNetUserLoginsDto>("tr");
            _mediatorMock.Setup(m => m.Send(It.IsAny<AspNetUserLoginsDeleteItemCommand>(), default)).ReturnsAsync(new Response<bool> { Code = 0, Value = true });
            // Act
        ...
        public async Task DeleteAsync_Should_Return_NotFound_When_404()
        {
            // Arrange
            var fakeDto = TestDataGenerator.CreateFake<AspNetUserLoginsDto>("tr");
            _mediatorMock.Setup(m => m.Send(It.IsAny<AspNetUserLoginsDeleteItemCommand>(), default)).ReturnsAsync(new Response<bool> { Code = 404, Message = "Not found" });
            // Act
            var result = await _controller.DeleteAsync(fakeDto.LoginProvider, fakeDto.ProviderKey);
            // Assert
            Assert.IsType<NotFoundObjectResult>(result);
        ...
        public async Task DeleteAsync_Should_Return_BadRequest_When_Fail()
        {
            // Arrange
            var fakeDto = TestDataGenerator.CreateFake<AspNetUserLoginsDto>("tr");
            _mediatorMock.Setup(m => m.Send(It.IsAny<AspNetUserLoginsDeleteItemCommand>(), default)).ReturnsAsync(new Response<bool> { Code = 1, Message = "Delete failed" });
            // Act
            var result = await _controller.DeleteAsync(fakeDto.LoginProvider, fakeDto.ProviderKey);
            // Assert
            Assert.IsType<BadRequestObjectResult>(result);
