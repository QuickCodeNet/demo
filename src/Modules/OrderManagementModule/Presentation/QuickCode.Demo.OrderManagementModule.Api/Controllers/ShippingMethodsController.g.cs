...
namespace QuickCode.Demo.OrderManagementModule.Api.Controllers
{
    public partial class ShippingMethodsController : QuickCodeBaseApiController
    {
        ...
        public ShippingMethodsController(IMediator mediator, IServiceProvider serviceProvider, ILogger<ShippingMethodsController> logger)
        {
        ...
        public async Task<IActionResult> ListAsync([FromQuery] int? page, int? size)
        {
            if (ValidatePagination(page, size) is {} error)
                return error;
            var response = await mediator.Send(new ListShippingMethodQuery(page, size));
        ...
        {
            var response = await mediator.Send(new TotalCountShippingMethodQuery());
        ...
        {
            var response = await mediator.Send(new GetItemShippingMethodQuery(id));
        ...
        {
            var response = await mediator.Send(new InsertShippingMethodCommand(model));
            if (HandleResponseError(response, logger, "ShippingMethod") is {} responseError)
                return responseError;
        ...
        public async Task<IActionResult> UpdateAsync(int id, ShippingMethodDto model)
        {
            ...
            var response = await mediator.Send(new UpdateShippingMethodCommand(id, model));
            if (HandleResponseError(response, logger, "ShippingMethod", $"Id: '{id}'") is {} responseError)
                return responseError;
            return Ok(response.Value);
        }
        ...
        {
            var response = await mediator.Send(new DeleteItemShippingMethodCommand(id));
            if (HandleResponseError(response, logger, "ShippingMethod", $"Id: '{id}'") is {} responseError)
                return responseError;
            return Ok(response.Value);
        }
        ...
        {
            var response = await mediator.Send(new DeactivateCommand(shippingMethodId, updateRequest));
