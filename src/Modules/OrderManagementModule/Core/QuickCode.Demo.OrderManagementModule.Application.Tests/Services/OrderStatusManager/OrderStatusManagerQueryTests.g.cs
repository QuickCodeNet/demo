...
{
    public class OrderStatusManagerTests : IDisposable
    {
        ...
        public OrderStatusManagerTests()
        {
        ...
        public async Task ListAsync_Should_Return_Success_When_Valid_Request()
        {
            ...
            var fakeResponse = new RepoResponse<List<OrderStatusManagerDto>>(fakeList, "Success");
