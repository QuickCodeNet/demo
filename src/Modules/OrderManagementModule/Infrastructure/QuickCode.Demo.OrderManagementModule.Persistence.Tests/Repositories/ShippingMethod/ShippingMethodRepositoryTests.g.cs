...
{
    public class ShippingMethodRepositoryTests : IDisposable
    {
        private readonly Mock<IDbConnectionFactory> connectionFactoryMock;
        private readonly Mock<ILogger<ShippingMethodRepository>> loggerMock;
        private readonly ITestOutputHelper _output;
        public ShippingMethodRepositoryTests(ITestOutputHelper output)
        {
            _output = output;
            connectionFactoryMock = new Mock<IDbConnectionFactory>();
            loggerMock = new Mock<ILogger<ShippingMethodRepository>>();
        }

        private ShippingMethodRepository CreateRepository()
        {
            return new ShippingMethodRepository(loggerMock.Object, connectionFactoryMock.Object);
        }
