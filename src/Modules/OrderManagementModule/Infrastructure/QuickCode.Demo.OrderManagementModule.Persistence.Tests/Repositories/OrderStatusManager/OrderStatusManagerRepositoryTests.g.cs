...
{
    public class OrderStatusManagerRepositoryTests : IDisposable
    {
        private readonly Mock<IDbConnectionFactory> connectionFactoryMock;
        private readonly Mock<ILogger<OrderStatusManagerRepository>> loggerMock;
        private readonly ITestOutputHelper _output;
        public OrderStatusManagerRepositoryTests(ITestOutputHelper output)
        {
            _output = output;
            connectionFactoryMock = new Mock<IDbConnectionFactory>();
            loggerMock = new Mock<ILogger<OrderStatusManagerRepository>>();
        }

        private OrderStatusManagerRepository CreateRepository()
        {
            return new OrderStatusManagerRepository(loggerMock.Object, connectionFactoryMock.Object);
        }
