...
{
    public static partial class OrderStatusManager
    {
        public static class Crud
        {
            private const string _prefix = "OrderManagementModule.OrderStatusManager.Crud";
            private const string _sqlScriptStem = "OrderStatusManager";
