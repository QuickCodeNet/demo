...
namespace QuickCode.Demo.IdentityModule.Persistence.Tests.Repositories
{
    public class ApiMethodDefinitionRepositoryTests : IDisposable
    {
        ...
        private readonly Mock<ILogger<ApiMethodDefinitionRepository>> loggerMock;
        ...
        {
            return new ApiMethodDefinitionRepository(loggerMock.Object, connectionFactoryMock.Object);
        }
