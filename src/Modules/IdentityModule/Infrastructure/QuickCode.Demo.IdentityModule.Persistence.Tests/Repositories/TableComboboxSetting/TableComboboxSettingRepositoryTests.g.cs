...
namespace QuickCode.Demo.IdentityModule.Persistence.Tests.Repositories
{
    public class TableComboboxSettingRepositoryTests : IDisposable
    {
        ...
        private readonly Mock<ILogger<TableComboboxSettingRepository>> loggerMock;
        ...
        {
            return new TableComboboxSettingRepository(loggerMock.Object, connectionFactoryMock.Object);
        }
