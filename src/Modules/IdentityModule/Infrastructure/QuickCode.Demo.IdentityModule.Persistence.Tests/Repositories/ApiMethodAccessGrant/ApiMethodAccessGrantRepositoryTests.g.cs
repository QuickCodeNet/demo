...
namespace QuickCode.Demo.IdentityModule.Persistence.Tests.Repositories
{
    public class ApiMethodAccessGrantRepositoryTests : IDisposable
    {
        ...
        private readonly Mock<ILogger<ApiMethodAccessGrantRepository>> loggerMock;
        ...
        {
            return new ApiMethodAccessGrantRepository(loggerMock.Object, connectionFactoryMock.Object);
        }
