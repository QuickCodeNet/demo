namespace QuickCode.Demo.IdentityModule.Persistence.Sql;
public static partial class SqlScripts
{
    public static partial class TableComboboxSetting
    {
        public static class Crud
        {
            private const string _prefix = "IdentityModule.TableComboboxSetting.Crud";
            private const string _sqlScriptStem = "TableComboboxSetting";
