...
{
    public static partial class AspNetUserToken
    {
        public static class Crud
        {
            private const string _prefix = "IdentityModule.AspNetUserToken.Crud";
            private const string _sqlScriptStem = "AspNetUserToken";
