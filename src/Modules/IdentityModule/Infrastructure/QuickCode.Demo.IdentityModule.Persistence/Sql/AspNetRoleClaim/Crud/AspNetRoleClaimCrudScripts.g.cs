...
{
    public static partial class AspNetRoleClaim
    {
        public static class Crud
        {
            private const string _prefix = "IdentityModule.AspNetRoleClaim.Crud";
            private const string _sqlScriptStem = "AspNetRoleClaim";
