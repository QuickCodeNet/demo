...
{
    public static partial class AspNetUserRole
    {
        public static class Crud
        {
            private const string _prefix = "IdentityModule.AspNetUserRole.Crud";
            private const string _sqlScriptStem = "AspNetUserRole";
