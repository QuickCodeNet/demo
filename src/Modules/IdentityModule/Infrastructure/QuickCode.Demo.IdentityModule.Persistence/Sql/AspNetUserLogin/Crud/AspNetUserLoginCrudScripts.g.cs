...
{
    public static partial class AspNetUserLogin
    {
        public static class Crud
        {
            private const string _prefix = "IdentityModule.AspNetUserLogin.Crud";
            private const string _sqlScriptStem = "AspNetUserLogin";
