...
namespace QuickCode.Demo.EmailManagerModule.Api.Controllers
{
    public partial class EmailSendersController : QuickCodeBaseApiController
    {
        ...
        public EmailSendersController(IMediator mediator, IServiceProvider serviceProvider, ILogger<EmailSendersController> logger)
        {
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(List<EmailSendersGetInfoMessagesForEmailSendersResponseDto>))]
        [ProducesResponseType(StatusCodes.Status404NotFound, Type = typeof(string))]
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))]
        public async Task<IActionResult> GetInfoMessagesForEmailSendersAsync(int emailSendersId)
        {
            var response = await mediator.Send(new EmailSendersGetInfoMessagesForEmailSendersQuery(emailSendersId));
            if (response.Code == 404)
            {
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(EmailSendersGetInfoMessagesForEmailSendersResponseDto))]
        [ProducesResponseType(StatusCodes.Status404NotFound, Type = typeof(string))]
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))]
        public async Task<IActionResult> GetInfoMessagesForEmailSendersDetailsAsync(int emailSendersId, int infoMessagesId)
        {
            var response = await mediator.Send(new EmailSendersGetInfoMessagesForEmailSendersDetailsQuery(emailSendersId, infoMessagesId));
            if (response.Code == 404)
            {
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(List<EmailSendersGetOtpMessagesForEmailSendersResponseDto>))]
        [ProducesResponseType(StatusCodes.Status404NotFound, Type = typeof(string))]
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))]
        public async Task<IActionResult> GetOtpMessagesForEmailSendersAsync(int emailSendersId)
        {
            var response = await mediator.Send(new EmailSendersGetOtpMessagesForEmailSendersQuery(emailSendersId));
            if (response.Code == 404)
            {
                var notFoundMessage = $"EmailSendersId: '{emailSendersId}' not found in EmailSenders Table";
                logger.LogWarning($"List Error: '{notFoundMessage}''");
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(EmailSendersGetOtpMessagesForEmailSendersResponseDto))]
        [ProducesResponseType(StatusCodes.Status404NotFound, Type = typeof(string))]
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))]
        public async Task<IActionResult> GetOtpMessagesForEmailSendersDetailsAsync(int emailSendersId, int otpMessagesId)
        {
            var response = await mediator.Send(new EmailSendersGetOtpMessagesForEmailSendersDetailsQuery(emailSendersId, otpMessagesId));
            if (response.Code == 404)
            {
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(List<EmailSendersGetCampaignMessagesForEmailSendersResponseDto>))]
        [ProducesResponseType(StatusCodes.Status404NotFound, Type = typeof(string))]
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))]
        public async Task<IActionResult> GetCampaignMessagesForEmailSendersAsync(int emailSendersId)
        {
            var response = await mediator.Send(new EmailSendersGetCampaignMessagesForEmailSendersQuery(emailSendersId));
            if (response.Code == 404)
            {
                var notFoundMessage = $"EmailSendersId: '{emailSendersId}' not found in EmailSenders Table";
                logger.LogWarning($"List Error: '{notFoundMessage}''");
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(EmailSendersGetCampaignMessagesForEmailSendersResponseDto))]
        [ProducesResponseType(StatusCodes.Status404NotFound, Type = typeof(string))]
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))]
        public async Task<IActionResult> GetCampaignMessagesForEmailSendersDetailsAsync(int emailSendersId, int campaignMessagesId)
        {
            var response = await mediator.Send(new EmailSendersGetCampaignMessagesForEmailSendersDetailsQuery(emailSendersId, campaignMessagesId));
            if (response.Code == 404)
            {
