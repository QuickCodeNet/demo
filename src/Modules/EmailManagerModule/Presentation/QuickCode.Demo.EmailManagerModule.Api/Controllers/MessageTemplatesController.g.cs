...
namespace QuickCode.Demo.EmailManagerModule.Api.Controllers
{
    ...
    {
        private readonly IMessageTemplateService service;
        private readonly ILogger<MessageTemplatesController> logger;
        private readonly IServiceProvider serviceProvider;
        public MessageTemplatesController(IMessageTemplateService service, IServiceProvider serviceProvider, ILogger<MessageTemplatesController> logger)
        {
        ...
        {
            var response = await service.GetItemAsync(name);
        ...
        public async Task<IActionResult> UpdateAsync(string name, MessageTemplateDto model)
        {
            ...
            var response = await service.UpdateAsync(name, model);
            if (HandleResponseError(response, logger, "MessageTemplate", $"Name: '{name}'") is {} responseError)
                return responseError;
            return Ok(response.Value);
        }
        ...
        {
            var response = await service.DeleteItemAsync(name);
            if (HandleResponseError(response, logger, "MessageTemplate", $"Name: '{name}'") is {} responseError)
                return responseError;
            return Ok(response.Value);
        }
        ...
        {
            var response = await service.GetByNameAsync(messageTemplatesName);
        ...
        {
            var response = await service.GetByTypeAsync(messageTemplatesType);
        ...
        {
            var response = await service.ExistsByNameAsync(messageTemplatesName);
            if (HandleResponseError(response, logger, "MessageTemplate", $"MessageTemplatesName: '{messageTemplatesName}'") is {} responseError)
                return responseError;
            return Ok(response.Value);
        }
        ...
        {
            var response = await service.GetCampaignsForMessageTemplatesAsync(messageTemplatesName);
            if (HandleResponseError(response, logger, "MessageTemplate", $"MessageTemplatesName: '{messageTemplatesName}'") is {} responseError)
                return responseError;
            return Ok(response.Value);
        }
        ...
        {
            var response = await service.GetCampaignsForMessageTemplatesDetailsAsync(messageTemplatesName, campaignsId);
        ...
        {
            var response = await service.GetMessagesForMessageTemplatesAsync(messageTemplatesName);
            if (HandleResponseError(response, logger, "MessageTemplate", $"MessageTemplatesName: '{messageTemplatesName}'") is {} responseError)
                return responseError;
            return Ok(response.Value);
        }
        ...
        {
            var response = await service.GetMessagesForMessageTemplatesDetailsAsync(messageTemplatesName, messagesId);
        ...
        {
            var response = await service.GetOtpMessagesForMessageTemplatesAsync(messageTemplatesName);
            if (HandleResponseError(response, logger, "MessageTemplate", $"MessageTemplatesName: '{messageTemplatesName}'") is {} responseError)
                return responseError;
            return Ok(response.Value);
        }
        ...
        {
            var response = await service.GetOtpMessagesForMessageTemplatesDetailsAsync(messageTemplatesName, otpMessagesId);
        ...
        {
            var response = await service.GetOtpMessageLogsForMessageTemplatesAsync(messageTemplatesName);
            if (HandleResponseError(response, logger, "MessageTemplate", $"MessageTemplatesName: '{messageTemplatesName}'") is {} responseError)
                return responseError;
            return Ok(response.Value);
        }
        ...
        {
            var response = await service.GetOtpMessageLogsForMessageTemplatesDetailsAsync(messageTemplatesName, otpMessageLogsId);
        ...
        {
            var response = await service.GetMessageLogsForMessageTemplatesAsync(messageTemplatesName);
            if (HandleResponseError(response, logger, "MessageTemplate", $"MessageTemplatesName: '{messageTemplatesName}'") is {} responseError)
                return responseError;
            return Ok(response.Value);
        }
        ...
        {
            var response = await service.GetMessageLogsForMessageTemplatesDetailsAsync(messageTemplatesName, messageLogsId);
        ...
        {
            var response = await service.UpdateContentAsync(messageTemplatesName, updateRequest);
            if (HandleResponseError(response, logger, "MessageTemplate", $"MessageTemplatesName: '{messageTemplatesName}'") is {} responseError)
                return responseError;
            return Ok(response.Value);
        }
        ...
        {
            var response = await service.UpdateTypeAsync(messageTemplatesName, updateRequest);
            if (HandleResponseError(response, logger, "MessageTemplate", $"MessageTemplatesName: '{messageTemplatesName}'") is {} responseError)
                return responseError;
            return Ok(response.Value);
        }
