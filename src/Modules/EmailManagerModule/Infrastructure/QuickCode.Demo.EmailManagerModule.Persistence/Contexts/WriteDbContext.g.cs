...
public partial class WriteDbContext : DbContext
{
	...
	protected override void OnModelCreating(ModelBuilder modelBuilder)
	{
		...
		modelBuilder.Entity<EmailSender>().Property(b => b.IsDeleted).IsRequired().HasDefaultValue(false);
		modelBuilder.Entity<EmailSender>().HasQueryFilter(r => !r.IsDeleted);
		...
		modelBuilder.Entity<EmailSender>().HasIndex(r => r.IsDeleted).HasFilter("IsDeleted = 0");
