...
{
    public class FinancialAdjustmentTests : IDisposable
    {
        ...
        public FinancialAdjustmentTests()
        {
        ...
        public async Task ListAsync_Should_Return_Success_When_Valid_Request()
        {
            ...
            var fakeResponse = new RepoResponse<List<FinancialAdjustmentDto>>(fakeList, "Success");
