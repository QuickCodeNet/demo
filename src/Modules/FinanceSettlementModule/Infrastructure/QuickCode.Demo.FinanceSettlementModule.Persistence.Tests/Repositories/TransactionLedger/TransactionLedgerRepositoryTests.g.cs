...
{
    public class TransactionLedgerRepositoryTests : IDisposable
    {
        private readonly Mock<IDbConnectionFactory> connectionFactoryMock;
        private readonly Mock<ILogger<TransactionLedgerRepository>> loggerMock;
        private readonly ITestOutputHelper _output;
        public TransactionLedgerRepositoryTests(ITestOutputHelper output)
        {
            _output = output;
            connectionFactoryMock = new Mock<IDbConnectionFactory>();
            loggerMock = new Mock<ILogger<TransactionLedgerRepository>>();
        }

        private TransactionLedgerRepository CreateRepository()
        {
            return new TransactionLedgerRepository(loggerMock.Object, connectionFactoryMock.Object);
        }
