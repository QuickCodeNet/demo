...
{
    public class PayoutPeriodRepositoryTests : IDisposable
    {
        private readonly Mock<IDbConnectionFactory> connectionFactoryMock;
        private readonly Mock<ILogger<PayoutPeriodRepository>> loggerMock;
        private readonly ITestOutputHelper _output;
        public PayoutPeriodRepositoryTests(ITestOutputHelper output)
        {
            _output = output;
            connectionFactoryMock = new Mock<IDbConnectionFactory>();
            loggerMock = new Mock<ILogger<PayoutPeriodRepository>>();
        }

        private PayoutPeriodRepository CreateRepository()
        {
            return new PayoutPeriodRepository(loggerMock.Object, connectionFactoryMock.Object);
        }
