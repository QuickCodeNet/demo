...
{
    public class FinancialAdjustmentRepositoryTests : IDisposable
    {
        private readonly Mock<IDbConnectionFactory> connectionFactoryMock;
        private readonly Mock<ILogger<FinancialAdjustmentRepository>> loggerMock;
        private readonly ITestOutputHelper _output;
        public FinancialAdjustmentRepositoryTests(ITestOutputHelper output)
        {
            _output = output;
            connectionFactoryMock = new Mock<IDbConnectionFactory>();
            loggerMock = new Mock<ILogger<FinancialAdjustmentRepository>>();
        }

        private FinancialAdjustmentRepository CreateRepository()
        {
            return new FinancialAdjustmentRepository(loggerMock.Object, connectionFactoryMock.Object);
        }
