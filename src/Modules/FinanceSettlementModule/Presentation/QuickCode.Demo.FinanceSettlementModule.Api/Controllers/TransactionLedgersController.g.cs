    ...
    public partial class TransactionLedgersController : QuickCodeBaseApiController
    {
        ...
        public async Task<IActionResult> ListAsync([FromQuery] int? page, int? size)
        {
            if (ValidatePagination(page, size) is {} error)
                return error;
            var response = await mediator.Send(new ListTransactionLedgerQuery(page, size));
        ...
        [HttpGet("get-transactions-by-type-and-date/{transactionLedgerSellerId:int}/{transactionLedgerTransactionType}/{transactionLedgerTransactionDateFrom:DateTime}/{transactionLedgerTransactionDateTo:DateTime}")]
        ...
        public async Task<IActionResult> GetTransactionsByTypeAndDateAsync(int transactionLedgerSellerId, TransactionType transactionLedgerTransactionType, DateTime transactionLedgerTransactionDateFrom, DateTime transactionLedgerTransactionDateTo, int? pageNumber, int? pageSize)
        {
            ...
            var response = await mediator.Send(new GetTransactionsByTypeAndDateQuery(transactionLedgerSellerId, transactionLedgerTransactionType, transactionLedgerTransactionDateFrom, transactionLedgerTransactionDateTo, pageNumber, pageSize));
            if (HandleResponseError(response, logger, "TransactionLedger", $"TransactionLedgerSellerId: '{transactionLedgerSellerId}', TransactionLedgerTransactionType: '{transactionLedgerTransactionType}', TransactionLedgerTransactionDateFrom: '{transactionLedgerTransactionDateFrom}', TransactionLedgerTransactionDateTo: '{transactionLedgerTransactionDateTo}'") is {} responseError)
                return responseError;
            return Ok(response.Value);
        }
    }
