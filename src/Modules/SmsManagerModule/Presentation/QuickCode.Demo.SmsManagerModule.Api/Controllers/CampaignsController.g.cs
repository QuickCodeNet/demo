...
namespace QuickCode.Demo.SmsManagerModule.Api.Controllers
{
    public partial class CampaignsController : QuickCodeBaseApiController
    {
        ...
        public CampaignsController(IMediator mediator, IServiceProvider serviceProvider, ILogger<CampaignsController> logger)
        {
        ...
        public async Task<IActionResult> ListAsync([FromQuery] int? page, int? size)
        {
            if (ValidatePagination(page, size) is {} error)
                return error;
            var response = await mediator.Send(new ListCampaignQuery(page, size));
        ...
        {
            var response = await mediator.Send(new TotalCountCampaignQuery());
        ...
        {
            var response = await mediator.Send(new GetItemCampaignQuery(id));
        ...
        {
            var response = await mediator.Send(new InsertCampaignCommand(model));
            if (HandleResponseError(response, logger, "Campaign") is {} responseError)
                return responseError;
        ...
        public async Task<IActionResult> UpdateAsync(int id, CampaignDto model)
        {
            ...
            var response = await mediator.Send(new UpdateCampaignCommand(id, model));
            if (HandleResponseError(response, logger, "Campaign", $"Id: '{id}'") is {} responseError)
                return responseError;
            return Ok(response.Value);
        }
        ...
        {
            var response = await mediator.Send(new DeleteItemCampaignCommand(id));
            if (HandleResponseError(response, logger, "Campaign", $"Id: '{id}'") is {} responseError)
                return responseError;
            return Ok(response.Value);
        }
        ...
        {
            var response = await mediator.Send(new GetByIdQuery(campaignsId));
        ...
        {
            var response = await mediator.Send(new GetActiveCampaignsQuery(campaignsIsActive));
        ...
        {
            var response = await mediator.Send(new GetByNameQuery(campaignsName));
        ...
        {
            var response = await mediator.Send(new ExistsByNameQuery(campaignsName));
            if (HandleResponseError(response, logger, "Campaign", $"CampaignsName: '{campaignsName}'") is {} responseError)
                return responseError;
            return Ok(response.Value);
        }
        ...
        {
            var response = await mediator.Send(new GetCampaignsCountQuery(campaignsIsActive));
            if (HandleResponseError(response, logger, "Campaign", $"CampaignsIsActive: '{campaignsIsActive}'") is {} responseError)
                return responseError;
            return Ok(response.Value);
        }
        ...
        {
            var response = await mediator.Send(new GetMessagesForCampaignsQuery(campaignsId));
            if (HandleResponseError(response, logger, "Campaign", $"CampaignsId: '{campaignsId}'") is {} responseError)
                return responseError;
            return Ok(response.Value);
        }
        ...
        {
            var response = await mediator.Send(new GetMessagesForCampaignsDetailsQuery(campaignsId, messagesId));
        ...
        {
            var response = await mediator.Send(new GetMessageQueuesForCampaignsQuery(campaignsId));
            if (HandleResponseError(response, logger, "Campaign", $"CampaignsId: '{campaignsId}'") is {} responseError)
                return responseError;
            return Ok(response.Value);
        }
        ...
        {
            var response = await mediator.Send(new GetMessageQueuesForCampaignsDetailsQuery(campaignsId, messageQueuesId));
        ...
        {
            var response = await mediator.Send(new UpdateStatusCommand(campaignsId, updateRequest));
            if (HandleResponseError(response, logger, "Campaign", $"CampaignsId: '{campaignsId}'") is {} responseError)
                return responseError;
            return Ok(response.Value);
        }
        ...
        {
            var response = await mediator.Send(new UpdatePriorityCommand(campaignsId, updateRequest));
            if (HandleResponseError(response, logger, "Campaign", $"CampaignsId: '{campaignsId}'") is {} responseError)
                return responseError;
            return Ok(response.Value);
        }
