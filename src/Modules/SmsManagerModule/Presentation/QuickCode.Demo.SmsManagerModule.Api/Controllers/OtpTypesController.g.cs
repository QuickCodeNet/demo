...
namespace QuickCode.Demo.SmsManagerModule.Api.Controllers
{
    public partial class OtpTypesController : QuickCodeBaseApiController
    {
        ...
        public OtpTypesController(IMediator mediator, IServiceProvider serviceProvider, ILogger<OtpTypesController> logger)
        {
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(List<OtpTypesGetOtpMessagesForOtpTypesResponseDto>))]
        [ProducesResponseType(StatusCodes.Status404NotFound, Type = typeof(string))]
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))]
        public async Task<IActionResult> GetOtpMessagesForOtpTypesAsync(int otpTypesId)
        {
            var response = await mediator.Send(new OtpTypesGetOtpMessagesForOtpTypesQuery(otpTypesId));
            if (response.Code == 404)
            {
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(OtpTypesGetOtpMessagesForOtpTypesResponseDto))]
        [ProducesResponseType(StatusCodes.Status404NotFound, Type = typeof(string))]
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))]
        public async Task<IActionResult> GetOtpMessagesForOtpTypesDetailsAsync(int otpTypesId, int otpMessagesId)
        {
            var response = await mediator.Send(new OtpTypesGetOtpMessagesForOtpTypesDetailsQuery(otpTypesId, otpMessagesId));
            if (response.Code == 404)
            {
