...
{
    /// <inheritdoc />
    public partial class AutoMigration_20250828_220520_370 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SMS_SENDERS", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SMS_SENDER_ID = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CAMPAIGN_MESSAGES_SMS_SENDERS_SMS_SENDER_ID",
                        column: x => x.SMS_SENDER_ID,
                        principalTable: "SMS_SENDERS",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_INFO_MESSAGES_SMS_SENDERS_SMS_SENDER_ID",
                        column: x => x.SMS_SENDER_ID,
                        principalTable: "SMS_SENDERS",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OTP_MESSAGES_SMS_SENDERS_SMS_SENDER_ID",
                        column: x => x.SMS_SENDER_ID,
                        principalTable: "SMS_SENDERS",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CAMPAIGN_MESSAGES_SMS_SENDER_ID",
                table: "CAMPAIGN_MESSAGES",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_INFO_MESSAGES_SMS_SENDER_ID",
                table: "INFO_MESSAGES",
                column: "SMS_SENDER_ID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OTP_MESSAGES_SMS_SENDER_ID",
                table: "OTP_MESSAGES",
                column: "SMS_SENDER_ID");
