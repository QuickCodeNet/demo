...
namespace QuickCode.Demo.SmsManagerModule.Application.Tests.Features.Message
{
    public class InsertMessageCommandTests : IDisposable
    {
        ...
        private readonly Mock<ILogger<InsertMessageCommand.InsertMessageHandler>> _loggerMock;
        public InsertMessageCommandTests()
        {
            _repositoryMock = new Mock<IMessageRepository>();
            _loggerMock = new Mock<ILogger<InsertMessageCommand.InsertMessageHandler>>();
        }
        ...
        public async Task Handle_Should_Return_Success_When_Valid_Command()
        {
            ...
            var handler = new InsertMessageCommand.InsertMessageHandler(_loggerMock.Object, _repositoryMock.Object);
            var command = new InsertMessageCommand(fakeDto);
            // Act
