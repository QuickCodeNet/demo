...
namespace QuickCode.Demo.SmsManagerModule.Application.Features.OtpMessageQueue
{
    public class GetByIdQuery : IRequest<Response<GetByIdResponseDto>>
    {
        ...
        public GetByIdQuery(int otpMessageQueuesId)
        {
        ...
        public class GetByIdHandler : IRequestHandler<GetByIdQuery, Response<GetByIdResponseDto>>
        {
            ...
            public GetByIdHandler(ILogger<GetByIdHandler> logger, IOtpMessageQueueRepository repository)
            {
                _logger = logger;
            ...
            {
                var returnValue = await _repository.GetByIdAsync(request.OtpMessageQueuesId);
