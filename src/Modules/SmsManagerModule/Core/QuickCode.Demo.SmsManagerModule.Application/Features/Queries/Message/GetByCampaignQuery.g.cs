...
namespace QuickCode.Demo.SmsManagerModule.Application.Features.Message
{
    public class GetByCampaignQuery : IRequest<Response<List<GetByCampaignResponseDto>>>
    {
        ...
        public GetByCampaignQuery(int messagesCampaignId)
        {
        ...
        public class GetByCampaignHandler : IRequestHandler<GetByCampaignQuery, Response<List<GetByCampaignResponseDto>>>
        {
            ...
            public GetByCampaignHandler(ILogger<GetByCampaignHandler> logger, IMessageRepository repository)
            {
                _logger = logger;
            ...
            {
                var returnValue = await _repository.GetByCampaignAsync(request.MessagesCampaignId);
