...
namespace QuickCode.Demo.SmsManagerModule.Application.Features.OtpMessage
{
    public class UpdateStatusCommand : IRequest<Response<int>>
    {
        ...
        public UpdateStatusCommand(int otpMessagesId, UpdateStatusRequestDto updateRequest)
        {
        ...
        public class UpdateStatusHandler : IRequestHandler<UpdateStatusCommand, Response<int>>
        {
            ...
            public UpdateStatusHandler(ILogger<UpdateStatusHandler> logger, IOtpMessageRepository repository)
            {
                _logger = logger;
            ...
            {
                var returnValue = await _repository.UpdateStatusAsync(request.OtpMessagesId, request.UpdateRequest);
