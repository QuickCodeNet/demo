...
namespace QuickCode.Demo.Infrastructure.Integration.Nswag.Extensions
{
    public static class NswagExtensions
    {
        ...
        public static void AddNswagServiceClient(this IServiceCollection services, IConfiguration configuration,
            ...
            string namespacePrefix = "QuickCode.Demo.Infrastructure.Integration.Nswag.Clients.")
        {
        ...
        public static void AddNswagServiceClient(this IServiceCollection services, IConfiguration configuration,
            Assembly assembly, bool addRetryHandler=false, string namespacePrefix = "QuickCode.Demo.Infrastructure.Integration.Nswag.Clients.")
        {
