...
void SetApiKeyToClients(IApiMethodAccessGrantsClient ApiMethodAccessGrantsClient, IApiMethodDefinitionsClient apiMethodDefinitionsClient, string configUserManagerApiKey)
{
    (ApiMethodAccessGrantsClient as ClientBase)!.SetApiKey(configUserManagerApiKey);
