...
{
    public class CampaignData : BaseComboBoxModel
    {
        ...
        public CampaignDto SelectedItem { get; set; }
        public List<CampaignDto> List { get; set; }
    }

    public static partial class CampaignExtensions
    {
        public static string GetKey(this CampaignDto dto)
        {
            return $"{dto.Id}";
        }
    }
