...
{
    public class CouponData : BaseComboBoxModel
    {
        ...
        public CouponDto SelectedItem { get; set; }
        public List<CouponDto> List { get; set; }
    }

    public static partial class CouponExtensions
    {
        public static string GetKey(this CouponDto dto)
        {
            return $"{dto.Id}";
        }
    }
