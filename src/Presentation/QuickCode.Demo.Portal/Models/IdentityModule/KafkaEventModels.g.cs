...
namespace QuickCode.Demo.Portal.Models.IdentityModule
{
    ...
    public class KafkaEventGetActiveKafkaEventsData : BaseComboBoxModel
    {
        public int TotalPage { get; set; }
        public int CurrentPage { get; set; }
        public int PageSize { get; set; }
    ...
    public class KafkaEventGetKafkaEventsData : BaseComboBoxModel
    {
        public int TotalPage { get; set; }
        public int CurrentPage { get; set; }
        public int PageSize { get; set; }
    ...
    public class KafkaEventGetTopicWorkflowsData : BaseComboBoxModel
    {
        public int TotalPage { get; set; }
        public int CurrentPage { get; set; }
        public int PageSize { get; set; }
    ...
    public class KafkaEventGetTopicWorkflowsKafkaEventsData : BaseComboBoxModel
    {
        public int TotalPage { get; set; }
        public int CurrentPage { get; set; }
        public int PageSize { get; set; }
