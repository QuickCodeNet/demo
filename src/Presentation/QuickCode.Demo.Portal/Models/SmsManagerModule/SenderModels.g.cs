...
{
    public class SenderData : BaseComboBoxModel
    {
        ...
        public SenderDto SelectedItem { get; set; }
        public List<SenderDto> List { get; set; }
    }

    public static partial class SenderExtensions
    {
        public static string GetKey(this SenderDto dto)
        {
            return $"{dto.Id}";
        }
    }
