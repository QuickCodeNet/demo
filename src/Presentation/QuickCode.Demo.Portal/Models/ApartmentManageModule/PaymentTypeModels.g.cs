...
{
    public class PaymentTypeData : BaseComboBoxModel
    {
        ...
        public PaymentTypeDto SelectedItem { get; set; }
        public List<PaymentTypeDto> List { get; set; }
    }

    public static partial class PaymentTypeExtensions
    {
        public static string GetKey(this PaymentTypeDto dto)
        {
            return $"{dto.Id}";
        }
    }
