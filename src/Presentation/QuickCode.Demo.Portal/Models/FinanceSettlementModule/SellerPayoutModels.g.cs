...
namespace QuickCode.Demo.Portal.Models.FinanceSettlementModule
{
    ...
    public class SellerPayoutGetByPeriodData : BaseComboBoxModel
    {
        public int TotalPage { get; set; }
        public int CurrentPage { get; set; }
        public int PageSize { get; set; }
    ...
    public class SellerPayoutGetBySellerIdData : BaseComboBoxModel
    {
        public int TotalPage { get; set; }
        public int CurrentPage { get; set; }
        public int PageSize { get; set; }
    ...
    public class SellerPayoutGetByStatusData : BaseComboBoxModel
    {
        public int TotalPage { get; set; }
        public int CurrentPage { get; set; }
        public int PageSize { get; set; }
