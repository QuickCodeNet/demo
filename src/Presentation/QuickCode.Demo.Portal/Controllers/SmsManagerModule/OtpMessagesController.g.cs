...
namespace QuickCode.Demo.Portal.Controllers.SmsManagerModule
{
    ...
    public partial class OtpMessagesController : BaseController
    {
        ...
        private async Task<OtpMessagesData> PrepareModel()
        {
        ...
        private async Task<Dictionary<string, Dictionary<string, string>>> FillPageComboBoxes(Dictionary<string, Dictionary<string, string>> comboBoxList)
        {
            ...
            comboBoxList.AddRange(await FillComboBoxAsync("OtpTypes", () => pageOtpTypesClient.OtpTypesListAsync()));
            return comboBoxList;
        }
    }
}