...
namespace QuickCode.Demo.Portal.Controllers.SmsManagerModule
{
    ...
    public partial class CampaignMessagesController : BaseController
    {
        ...
        private async Task<CampaignMessagesData> PrepareModel()
        {
        ...
        private async Task<CampaignMessagesData> PrepareModel(CampaignMessagesData model)
        {
        ...
        {
            comboBoxList.Clear();
            comboBoxList.AddRange(await FillComboBoxAsync("SmsSenders", () => pageSmsSendersClient.SmsSendersListAsync()));
            comboBoxList.AddRange(await FillComboBoxAsync("CampaignTypes", () => pageCampaignTypesClient.CampaignTypesListAsync()));
            return comboBoxList;
        }
    }
}