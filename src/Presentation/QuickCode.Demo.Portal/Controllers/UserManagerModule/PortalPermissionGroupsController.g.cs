...
namespace QuickCode.Demo.Portal.Controllers.UserManagerModule
{
    ...
    public partial class PortalPermissionGroupsController : BaseController
    {
        ...
        public async Task<IActionResult> Update(PortalPermissionGroupsData model)
        {
            ...
            var result = await pageClient.PortalPermissionGroupsUpdateAsync(request.Id, request);
            ClearCache();
            SetModelBinder(ref model);
            return Ok(result);
        }
        ...
        private async Task<PortalPermissionGroupsData> PrepareModel()
        {
        ...
        private async Task<PortalPermissionGroupsData> PrepareModel(PortalPermissionGroupsData model)
        {
        ...
        {
            comboBoxList.Clear();
            comboBoxList.AddRange(await FillComboBoxAsync("PortalPermissions", () => pagePortalPermissionsClient.PortalPermissionsListAsync()));
            comboBoxList.AddRange(await FillComboBoxAsync("PermissionGroups", () => pagePermissionGroupsClient.PermissionGroupsListAsync()));
            comboBoxList.AddRange(await FillComboBoxAsync("PortalPermissionTypes", () => pagePortalPermissionTypesClient.PortalPermissionTypesListAsync()));
            return comboBoxList;
        }
    }
}