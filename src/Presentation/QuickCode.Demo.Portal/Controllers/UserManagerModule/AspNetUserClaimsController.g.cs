...
namespace QuickCode.Demo.Portal.Controllers.UserManagerModule
{
    ...
    public partial class AspNetUserClaimsController : BaseController
    {
        ...
        [Route("List")]
        [HttpPost]
        public async Task<IActionResult> List(AspNetUserClaimsData model)
        {
        ...
        [Route("Insert")]
        [HttpPost]
        public async Task<IActionResult> Insert(AspNetUserClaimsData model)
        {
            ModelBinder(ref model);
        ...
        [Route("Update")]
        [HttpPost]
        public async Task<IActionResult> Update(AspNetUserClaimsData model)
        {
            ModelBinder(ref model);
        ...
        [Route("Delete")]
        [HttpPost]
        public async Task<IActionResult> Delete(AspNetUserClaimsData model)
        {
            ModelBinder(ref model);
            var request = model.SelectedItem;
        ...
        [Route("InsertItem")]
        public IActionResult InsertItem(AspNetUserClaimsData model)
        {
            ModelState.Clear();
            ModelBinder(ref model);
            SetModelBinder(ref model);
        ...
        [Route("DetailItem")]
        public async Task<IActionResult> DetailItem(AspNetUserClaimsData model)
        {
            ModelBinder(ref model);
            model = await PrepareModel(model);
        ...
        [Route("UpdateItem")]
        [HttpPost]
        public async Task<IActionResult> UpdateItem(AspNetUserClaimsData model)
        {
            ModelState.Clear();
            ModelBinder(ref model);
            model = await PrepareModel(model);
        ...
        [Route("DeleteItem")]
        [HttpPost]
        public async Task<IActionResult> DeleteItem(AspNetUserClaimsData model)
        {
            ModelBinder(ref model);
            model = await PrepareModel(model);
            model.SelectedItem = model.List.Find(i => i.GetKey() == model.SelectedKey);
        ...
        private async Task<AspNetUserClaimsData> PrepareModel()
        {
            var model = GetModel<AspNetUserClaimsData>();
            model.CurrentPage = 1;
            model.PageSize = PageSize;
            return await PrepareModel(model);
        }

        private async Task<AspNetUserClaimsData> PrepareModel(AspNetUserClaimsData model)
        {
        ...
        {
            comboBoxList.Clear();
            comboBoxList.AddRange(await FillComboBoxAsync("AspNetUsers", () => pageAspNetUsersClient.AspNetUsersListAsync()));
            return comboBoxList;
        }
    }
}