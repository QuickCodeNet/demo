...
namespace QuickCode.Demo.Portal.Controllers.UserManagerModule
{
    ...
    public partial class ColumnTypesController : BaseController
    {
        ...
        public ColumnTypesController(UserManagerModuleContracts.IColumnTypesClient pageClient, UserManagerModuleContracts.ITableComboboxSettingsClient tableComboboxSettingsClient, IHttpContextAccessor httpContextAccessor, IMemoryCache cache) : base(tableComboboxSettingsClient, httpContextAccessor, cache)
        {
        ...
        private async Task<ColumnTypesData> PrepareModel()
        {
        ...
        private async Task<ColumnTypesData> PrepareModel(ColumnTypesData model)
        {
            model.NumberOfRecord = await pageClient.ColumnTypesCountAsync();
            model.TotalPage = (model.NumberOfRecord + PageSize - 1) / PageSize;
            model.List = (await pageClient.ColumnTypesListAsync(model.CurrentPage, PageSize)).ToList();
            return model;
        }
    }
}