...
namespace QuickCode.Demo.Portal.Controllers.UserManagerModule
{
    ...
    public partial class PortalMenusController : BaseController
    {
        ...
        public PortalMenusController(UserManagerModuleContracts.IPortalMenusClient pageClient, UserManagerModuleContracts.ITableComboboxSettingsClient tableComboboxSettingsClient, IHttpContextAccessor httpContextAccessor, IMemoryCache cache) : base(tableComboboxSettingsClient, httpContextAccessor, cache)
        {
        ...
        public async Task<IActionResult> Update(PortalMenusData model)
        {
            ...
            var result = await pageClient.PortalMenusUpdateAsync(request.Id, request);
            ClearCache();
            SetModelBinder(ref model);
            return Ok(result);
        }
        ...
        private async Task<PortalMenusData> PrepareModel()
        {
        ...
        private async Task<PortalMenusData> PrepareModel(PortalMenusData model)
        {
            if (model.List == null)
            {
                ...
                model.List = (await pageClient.PortalMenusListAsync(model.CurrentPage, PageSize)).ToList();
            }
