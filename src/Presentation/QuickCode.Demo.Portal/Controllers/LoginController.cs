...
using LoginRequest = QuickCode.Demo.Common.Nswag.Clients.IdentityModuleApi.Contracts.LoginRequest;


using ForgotPasswordRequest = QuickCode.Demo.Common.Nswag.Clients.IdentityModuleApi.Contracts.ForgotPasswordRequest;
using ResetPasswordRequest = QuickCode.Demo.Common.Nswag.Clients.IdentityModuleApi.Contracts.ResetPasswordRequest;
