...
namespace QuickCode.Demo.Portal.Controllers.EmailManagerModule
{
    ...
    public partial class OtpMessagesController : BaseController
    {
        ...
        private readonly EmailManagerModuleContracts.IOtpTypesClient pageOtpTypeClient;
        public OtpMessagesController(EmailManagerModuleContracts.IOtpMessagesClient pageClient, EmailManagerModuleContracts.IEmailSendersClient pageEmailSenderClient, EmailManagerModuleContracts.IOtpTypesClient pageOtpTypeClient, UserManagerModuleContracts.ITableComboboxSettingsClient tableComboboxSettingsClient, IHttpContextAccessor httpContextAccessor, IMemoryCache cache) : base(tableComboboxSettingsClient, httpContextAccessor, cache)
        {
