...
namespace QuickCode.Demo.Portal.Controllers.EmailManagerModule
{
    ...
    public partial class OtpTypesController : BaseController
    {
        ...
        public OtpTypesController(EmailManagerModuleContracts.IOtpTypesClient pageClient, UserManagerModuleContracts.ITableComboboxSettingsClient tableComboboxSettingsClient, IHttpContextAccessor httpContextAccessor, IMemoryCache cache) : base(tableComboboxSettingsClient, httpContextAccessor, cache)
        {
