...
namespace QuickCode.Demo.Portal.Controllers
{
    public class BaseController : Controller
    {
		...
		private string UploadImageAsBlob(IFormFile file, MemoryStream memoryStream)
        {
            ...
            var storageConnectionString = $"DefaultEndpointsProtocol=https;AccountName=quickcodeblobstorage;AccountKey={accountKey};EndpointSuffix=core.windows.net";
            var baseUrl = "https://quickcodeblobstorage.blob.core.windows.net";
